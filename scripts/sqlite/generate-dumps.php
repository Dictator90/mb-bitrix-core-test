...
function dumpSqliteDatabase(string $sqlitePath, string $outputPath): void
{
    ...
    $dumper = new \MB\BitrixTest\Database\Dump\SqliteDumper();
    $dumper->dump($pdo, $outputPath);
}

function appendRequiredModulesDump(string $sqlPath): void
{
    $appender = new \MB\BitrixTest\Database\Dump\RequiredModulesSqlAppender();
    $appender->append($sqlPath);
}
